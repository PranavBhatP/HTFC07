...
const LoaderModal = () => {
  return (
    <>
      <div className="h-screen w-screen bg-[#120624] relative">
        <div className="absolute flex flex-col justify-evenly items-center gap-5 inset-x-1/2 inset-y-1/2 -translate-x-1/2 -translate-y-1/2 w-[25vw] h-[20vw]">
          <video
            src={Superman}
            loop
            autoPlay
          ...
          ></video>
          <h1 className="text-xl text-white fira-sans-medium">
            Scouring 200k Entries, Just for You 😗...
          </h1>
        </div>
      </div>
    </>
                ...
                <div className="w-full h-full flex flex-col justify-center items-center gap-[10px]">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="text-white py-3 px-5 border-2 border-zinc-600 rounded flex flex-row hover:bg-white hover:text-black hover:scale-110 duration-200"
                    >
                      Run Model :D
                    </button>
                  </form>
